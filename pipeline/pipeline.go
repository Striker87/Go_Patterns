...
// на каждом этапе горутины получают значения предыдущего этапа с входных каналов, выполняют их обработку, отправляют на следующий этап новые значение через выходные каналы
